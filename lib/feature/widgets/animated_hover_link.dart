...
class AnimatedHoverLink extends AnimatedWidget {
  AnimatedHoverLink({super.key, required this.label, required this.controller})
        ...
        return MouseRegion(
          ...
          child: AnimatedTextSlideBoxTransition(
            ...
            textStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(
              ...
              decorationThickness: hover ? 5 : 3,
              decorationColor: hover ? Colors.black : Colors.transparent,
            ),
          ),
        );
      },
