...
import 'package:flutter_portfolio/feature/presentation/home/widgets/home_page_body.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<NavModel> navItems = [
      NavModel(title: "My Projects", path: Routes.projects),
      NavModel(title: "About Me", path: Routes.about),
      NavModel(title: "Contact Me", path: Routes.contactMe),
    ];
    return Scaffold(
