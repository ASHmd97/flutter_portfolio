...
import 'package:flutter_portfolio/feature/presentation/home/widgets/custom_button.dart';
...
class RightSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(ksCraftedWithLove, style: FigmaTextStyles().displaytextExtraBold),
        Text(ksRecentProjects, style: FigmaTextStyles().paragraphP2Regular),
