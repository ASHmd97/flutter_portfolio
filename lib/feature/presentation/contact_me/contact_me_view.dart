...
import 'package:flutter_portfolio/feature/data/configs/constant_assets.dart';
...
import 'package:flutter_portfolio/feature/presentation/contact_me/animated_text_field.dart';
      ...
      <Widget>[
            Text(
              ...
              style: context.adaptive(
                FigmaTextStyles().paragraphP3Regular,
            ...
            <Widget>[
              const ContactLabel(label: 'Hey, my name is'),
              AnimatedTextField(
              ...
              const ContactLabel(label: "and I'm looking for"),
              AnimatedTextField(
              ...
              const ContactLabel(label: 'Get in touch with me at'),
              AnimatedTextField(
              ...
              const ContactLabel(
                label:
                    "I have some special request & more info to tell you about",
              ),
              AnimatedTextField(
                isMultiline: true,
              ...
              spacing: context.percentWidth(s1),
              vSpacing: context.percentHeight(context.adaptive(s1, s6)),
            ),
            ...
            PrettyCapsuleButton(
              ...
              icon: kiMemo,
              padding: context.symmetricPadding(h: s50, v: s18),
          ...
          .addScrollView(physics: const PageScrollPhysics()),
        ...
        child:
            <Widget>[
                ...
                .addContainer(
                  ...
                  margin: context.percentPadding(b: s3),
                  padding: context.symmetricPadding(h: s30, v: s14),
                ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: context.adaptive(
        ...
        FigmaTextStyles().displaytextMRegular.copyWith(fontSize: 30),
      ),
    );
  }
}
