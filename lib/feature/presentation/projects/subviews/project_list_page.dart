...
class _ProjectListPageState extends State<ProjectListPage>
  ...
  void initState() {
    ...
    _projectSlideController = AnimationController(
      vsync: this,
      duration: duration3000,
    )..addStatusListener(projectSlideListener);
    _slideOpacityController = AnimationController(
      vsync: this,
      duration: duration500,
    );
    _toolOpacityController = AnimationController(
      vsync: this,
      duration: duration500,
          ...
          <Widget>[
            ...
            <Widget>[
                  ...
                  AnimatedTextSlideBoxTransition(
                    ...
                    textStyle: FigmaTextStyles().headingH2Regular,
                  ),
                ]
...
class HorizontalProjectList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return <Widget>[
      ...List.generate(ksShowcaseProjects.length, (index) {
